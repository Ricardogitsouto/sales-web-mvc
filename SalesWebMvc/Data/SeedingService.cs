...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void seed()
        {
            ...
            Department d1 = new Department(1, "Computers", null);
            Department d2 = new Department(2, "Electronics", null);
            Department d3 = new Department(3, "Fashion", null);
            Department d4 = new Department(4, "Books", null);
